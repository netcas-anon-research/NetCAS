...
set output 'graph_logs_cas-NETCAS_with_contention_multi_config/_dev_cas1-1_iodepth1_jobs2/_dev_cas1-1_iodepth1_jobs2_latency.png'
set title 'Latency over time - _dev_cas1-1_iodepth1_jobs2 (With Server-Side Contention Timing)'
...
plot 'graph_logs_cas-NETCAS_with_contention_multi_config/_dev_cas1-1_iodepth1_jobs2/_dev_cas1-1_iodepth1_jobs2_lat.1.log' using 1:2 with lines title 'Latency (us)'
